...
public:
        ...
        : Node("hello_sub")
    {
        ...
        _pose_sub = create_subscription<turtlesim::msg::Pose>(
            "turtle1/pose",
            qos_profile,
            std::bind(&MoveTurtle::_pose_sub_callback, this, std::placeholders::_1));

        _color_sub = create_subscription<turtlesim::msg::Color>(
            "turtle1/color",
            qos_profile,
            std::bind(&MoveTurtle::_color_sub_callback, this, std::placeholders::_1));

        _pub = create_publisher<geometry_msgs::msg::Twist>("turtle1/cmd_vel", 10);
...
private:
    ...
    void _pose_sub_callback(const turtlesim::msg::Pose::SharedPtr msg)
    {
        _pose = *msg;
    }

    void _color_sub_callback(const turtlesim::msg::Color::SharedPtr msg)
    {
        _color = *msg;
    }
